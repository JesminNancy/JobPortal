            ...
            <form action="{{ route('company_jobs_update',$jobs_single->id) }}" method="post">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="title" class="form-control" value="{{ $jobs_single->title }}" />
                    </div>
                </div>
                <div class="mb-3">
                    <label for="" class="form-label">Description</label>
                    <textarea
                        name="description" class="form-control editor" cols="30" rows="10">{{ $jobs_single->description }}
                    </textarea>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea
                            name="responsibility" class="form-control editor" cols="30" rows="10">{{ $jobs_single->responsibilty }}
                        </textarea>
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="job_salary_range_id" class="form-control select2">
                            @foreach ($job_salary_ranges as $item)
                                <option value="{{ $item->id }}" @if($item->id == $jobs_single->job_salary_ranges_id)selected @endif>{{ $item->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea
                            name="map_code" class="form-control h-150" cols="30" rows="10">{{ $jobs_single->map_code }}
                        </textarea>
                    </div>
                </div>
