        ...
        <div class="col-lg-9 col-md-12">
            <form action="{{ route('company_jobs_create_submit') }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <textarea
                        name="description" class="form-control editor" cols="30" rows="10">{{ old('description') }}
                    </textarea>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea
                            name="responsibility" class="form-control editor" cols="30" rows="10">{{ old('responsibilty') }}
                        </textarea>
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea
                            name="map_code" class="form-control h-150" cols="30" rows="10">{{ old('map_code') }}
                        </textarea>
                    </div>
                </div>
