                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="form-group">
                                @if(Auth::guard('candidate')->user()->photo == '')
                                    <img src="{{ asset('uploads/A.png') }}" alt="" class="photo"/>
                                @else
                                <img src="{{ asset('uploads/'.Auth::guard('candidate')->user()->photo) }}" alt="" class="photo">
                                @endif
                            </div>
                        </div>
                        <div class="col-md-12 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-group">
                                <select name="gender" class="form-control select2">
                                    ...
                                    <option value="Female" @if(Auth::guard('candidate')->user()->gender == 'Female') @endif>Female</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
