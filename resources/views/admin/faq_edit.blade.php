...
@section('button')
<div>
    <a href="{{ route('admin_fqa') }}" class="btn btn-primary"><i class="fas fa-plus"></i> View All</a>
</div>
@endsection
...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin_fqa_update',$faq_single->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
