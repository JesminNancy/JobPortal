    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown">
                <a href="{{ Request::is('admin/job_category/view')||Request::is('admin/job_location/view') ? 'active' : '' }}" class="nav-link has-dropdown"><i class="fas fa-hand-point-right"></i><span>Job Section</span></a>
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ ('/admin/job_location/view') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_job_location_view') }}"><i class="fas fa-angle-right"></i> Job Location</a></li>
                </ul>
            </li>
