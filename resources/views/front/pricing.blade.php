                ...
                <div class="card mb-5 mb-lg-0">
                    <div class="card-body">
                        ...
                        <ul class="fa-ul">
                            <li>
                                @php
                                    if($item->total_allowed_job == -1) {
                                        $text = "Unlimited";
                                        $icon_code = "fas fa-check";
                                    } elseif($item->total_allowed_job == 0) {
                                        $text = "No";
                                        $icon_code = "fas fa-times";
                                    } else {
                                        $text = $item->total_allowed_job;
                                        $icon_code = "fas fa-check";
                                    }
                                @endphp
                            ...
                            <li>
                                @php
                                    if($item->total_allowed_featured_job == -1) {
                                        $text = "Unlimited";
                                        $icon_code = "fas fa-check";
                                    } elseif($item->total_allowed_featured_job == 0) {
                                        $text = "No";
                                        $icon_code = "fas fa-times";
                                    } else {
                                        $text = $item->total_allowed_featured_job;
                                        $icon_code = "fas fa-check";
                                    }
                                @endphp
                                <span class="fa-li"><i class="{{ $icon_code }}"></i></span>
